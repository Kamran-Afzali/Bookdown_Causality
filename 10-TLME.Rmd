...
## Theoretical Foundations: The Semiparametric Revolution

### The Efficiency Frontier in Causal Inference
...
### The Influence Function and Double Robustness
...
### The TMLE Algorithm: Targeted Bias Reduction
...
### Clinical Context and Data Generation
...
initial_Q <- tmle_result$Qinit$Q
targeted_Q <- tmle_result$Qstar$Q
...
results_comparison$CI_Lower <- results_comparison$ATE - 1.96 * results_comparison$SE
results_comparison$CI_Upper <- results_comparison$ATE + 1.96 * results_comparison$SE
...
## Computational Considerations and Implementation Challenges
